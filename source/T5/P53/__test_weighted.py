from source.T5.P51.PlainGraph import PlainGraph, inputGraphWithRandomVertexPositions
from source.T5.P52.Ways import waySearch, waySearchByWave
from source.T5.P53.AStar import AStar
from source.T5.P53.BelmanFord import BelmanFord, BelmanFordOptimized
from source.T5.P53.Dijkstra import Dijkstra
