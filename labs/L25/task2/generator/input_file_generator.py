...
if __name__ == "__main__":
    ...
    generate("input01.txt", 100, 300)
    generate("input02.txt", 500, 1534)
    generate("input03.txt", 1000, 10000)
    generate("input04.txt", 1000, 10000)
    generate("input05.txt", 1000, 10000)
    generate("input06.txt", 1000, 10000)
    generate("input07.txt", 1000, 10000)
    generate("input08.txt", 10000, 50000)
    generate("input09.txt", 10000, 50000)
    generate("input10.txt", 10000, 50000)
    generate("input11.txt", 10000, 50000)
    generate("input12.txt", 10000, 50000)
    generate("input13.txt", 10000, 50000)
    generate("input14.txt", 10000, 50000)
    generate("input15.txt", 10000, 50000)
